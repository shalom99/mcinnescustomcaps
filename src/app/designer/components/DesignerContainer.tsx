...
const DesignerContainer: FC<DesignerProps> = () => {
  ...
  return (
    <div className="relative w-full h-[450px] lg:w-[600px] lg:h-[600px] p-5">
      ...
      <div className="absolute left-0 right-0 bottom-0 lg:-bottom-5 flex justify-center gap-x-6 z-20 shadow-2xl bg-gray-300 rounded-full py-2">
        ...
        {/* <p>
          top: {fLogo.top} - left: {fLogo.left}
          width: {fLogo.width} - height: {fLogo.height}
          mainContainerLeft: {}
        </p> */}
      </div>
    </div>
