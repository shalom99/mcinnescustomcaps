...
import { useCapItemStore, useLabelStore, useCartStore} from '@/libs/store/index'
      ...
      <div className=" bg-gray-600 flex justify-center pt-10 lg:pt-32 pb-10">
        ...
        >
          ...
          >
            ...
            <div id="tableBody" className="grid grid-cols-6 auto-cols-max items-center py-10">
        ...
        {removeItemModal ?      <RemoveItem setRemoveItemModal={setRemoveItemModal} /> : ''
        }
      </div>
    );
